...
This server:
- Talks to DSM's Web API as a dedicated non-admin DSM user `claude-mcp` (2FA enforced).
...
| DSM user | `claude-mcp` (non-admin, 2FA, app-scoped privileges) |
| Secrets | 1Password item "Synology DSM — claude-mcp" |
